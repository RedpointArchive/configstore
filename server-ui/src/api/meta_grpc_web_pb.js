 ...
 * @const
 * @type {!grpc.web.AbstractClientBase.MethodInfo<
 *   !proto.meta.MetaTransaction,
 *   !proto.meta.MetaTransactionResult>}
 */
const methodInfo_ConfigstoreMetaService_ApplyTransaction = new grpc.web.AbstractClientBase.MethodInfo(
  proto.meta.MetaTransactionResult,
  /** @param {!proto.meta.MetaTransaction} request */
  function(request) {
    return request.serializeBinary();
  },
  proto.meta.MetaTransactionResult.deserializeBinary
);


/**
 * @param {!proto.meta.MetaTransaction} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.Error, ?proto.meta.MetaTransactionResult)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.meta.MetaTransactionResult>|undefined}
 *     The XHR Node Readable Stream
 */
proto.meta.ConfigstoreMetaServiceClient.prototype.applyTransaction =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/meta.ConfigstoreMetaService/ApplyTransaction',
      request,
      metadata || {},
      methodInfo_ConfigstoreMetaService_ApplyTransaction,
      callback);
};
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.meta.MetaTransactionResult>}
 *     A native promise that resolves to the response
 */
proto.meta.ConfigstoreMetaServicePromiseClient.prototype.applyTransaction =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/meta.ConfigstoreMetaService/ApplyTransaction',
      request,
